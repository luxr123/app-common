...
package com.dream.common.utils.user;
...
import com.dream.common.web.utils.IpUtils;
import com.dream.common.web.utils.LogUtils;

/**
 * User: xiaorui.lu
 * Date: 2013年12月15日 下午9:11:12
 */
public class UserLogUtils {
  private static final Logger SYS_USER_LOGGER = LoggerFactory.getLogger("system_user");
